...
import { isEmail, isNonEmpty, validate } from '../utils/validation';
...
const loginSchema = {
  ...
  password: [{ test: isNonEmpty, message: 'Enter your password.' }],
};
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    const nextValidation = validate(formData, loginSchema);
      ...
      <div className="lu-auth-card">
        ...
        <form onSubmit={handleSubmit} className="lu-form" noValidate>
          <div className="lu-form-group">
            ...
            />
            {errors.email && <span id="login-email-error" role="alert" className="form-error">{errors.email}</span>}
          </div>
          ...
          <div className="lu-form-group">
            ...
            />
            {errors.password && <span id="login-password-error" role="alert" className="form-error">{errors.password}</span>}
          </div>
