...
const registerSchema = {
  ...
  password: [
    { test: isNonEmpty, message: 'Enter a password.' },
    { test: isStrongPassword, message: 'Use at least 8 characters with letters and numbers.' },
  ],
};
...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    const nextValidation = validate(formData, registerSchema);
  ...
  return (
    <div className="lu-auth-page">
      ...
      <div className="lu-auth-card">
        ...
        <form onSubmit={handleSubmit} className="lu-form" noValidate>
          <div className="lu-form-group">
            ...
            />
            {errors.name && <span id="register-name-error" role="alert" className="form-error">{errors.name}</span>}
          </div>
          ...
          <div className="lu-form-group">
            ...
            />
            {errors.email && <span id="register-email-error" role="alert" className="form-error">{errors.email}</span>}
          </div>

          <div className="lu-form-group">
            <label className="lu-form-label" htmlFor="phone">Phone Number</label>
            <input
              id="phone"
              name="phone"
              type="tel"
            ...
            />
            {errors.phone && <span id="register-phone-error" role="alert" className="form-error">{errors.phone}</span>}
          </div>
          ...
          <div className="lu-form-group">
            ...
            />
            <span id="register-password-hint" className="form-hint">
              Use at least 8 characters and include both letters and numbers.
            </span>
            {errors.password && <span id="register-password-error" role="alert" className="form-error">{errors.password}</span>}
          </div>
